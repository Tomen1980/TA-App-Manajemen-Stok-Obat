...
<div class="bg-blue-800 text-white w-64 min-h-screen transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out fixed md:relative" id="sidebar">
    ...
    <nav class="p-4">
        ...
        <li class="mb-2">
            <a href="/admin/drugs/typed" class="flex items-center p-2 hover:bg-blue-700 rounded" >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
                Drugs
        ...
        <li class="mb-2">
            <a href="/admin/category/list-category" class="flex items-center p-2 hover:bg-blue-700 rounded" >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li class="mb-2">
            <a href="/admin/suppliers/list-supplier" class="flex items-center p-2 hover:bg-blue-700 rounded" >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <li class="mb-2">
            <a href="/admin/user/list-user" class="flex items-center p-2 hover:bg-blue-700 rounded">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
