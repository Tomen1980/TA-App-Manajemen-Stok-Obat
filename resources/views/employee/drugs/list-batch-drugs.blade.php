    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="px-4 sm:px-6 py-4 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            ...
            <div class="mt-2 md:mt-0">
                <a href="/employee/drugs/stock-list" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg inline-flex items-center">
        ...
        <div class="px-4 sm:px-6 py-4 bg-gray-50 border-b border-gray-200">
            <form action="/employee/drugs/stock-list/{{ $data->id }}/batch-drugs" method="GET" class="flex flex-col sm:flex-row gap-3 justify-end">
                <!-- Status Filter -->
