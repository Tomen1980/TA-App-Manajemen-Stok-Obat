    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="mt-2 md:mt-0 flex space-x-2">
                <form action="/employee/history-transaction-outgoing/" method="POST">
                    @csrf
                    @method('POST')
        ...
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <form action="/employee/history-transaction-outgoing" method="GET" class="flex flex-col md:flex-row gap-4">
                <!-- Date Range -->
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-2">
                                <!-- View Button -->
                                <a href="/employee/transaction-outgoing/{{$item->id}}" class="text-green-600 hover:text-green-900 flex items-center">
                                ...
                                <!-- Print Button -->
                                <form action="/employee/get-one-transaction-outgoing/" method="POST">
                                    @csrf
                                    @method('POST')
                                ...
                                <!-- Delete Button -->
                                <form action="/employee/history-transaction-outgoing/{{$item->id}}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus transaksi ini?')">
                                    @csrf
                                    @method('DELETE')
